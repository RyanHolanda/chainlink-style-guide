...
This repository contains the Chainlink recommended style guide for developing smart contracts with solidity.
...
- Test using Foundry.
- Aim for at least 90% _useful_ coverage as a baseline, but (near) 100% is achievable in Solidity. Always 100% test the critical path.
